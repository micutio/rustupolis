...
impl Client{
    pub fn new(tuple_space: Arc<Mutex<Space<SimpleStore>>>, attributes: Vec<String>, tuple_space_name: &str ) -> Client {
    ...
    pub fn tuple_space_name(&self) -> &str {&self.tuple_space_name}
}
